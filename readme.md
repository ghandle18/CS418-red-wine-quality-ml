...
| Name | Contributions |
|------|--------------|
| **Brian Ta** | Colab Notebook Data Preparation, Regression |
| **Mahsa Alishiri** | Colab Notebook Classification |
| **Han Dang** | Colab Notebook EDA, Report, Presentation, README File |
